...
class PsyDataset(DatasetWrapper):
    def __init__(self, dataset_path, include_labels= None, split=None, split_file=None,
                 sub_sample_frac=None, data_views=None, 
                 transform_dict_core=None, transform_dict_artifact=None, transform_global_core=None, transform_global_artifact=None, data_name=None):
        """
        ...
        self.timezone = "utc"
        self.num_subjects = 78 
        super().__init__(dataset_path, y_dim, split, split_file, sub_sample_frac, data_views, 
        transform_dict_core, transform_dict_artifact, transform_global_core, transform_global_artifact, data_name=None)
