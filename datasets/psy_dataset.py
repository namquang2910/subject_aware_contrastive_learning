...
class PsyDataset(DatasetWrapper):
    def __init__(self, dataset_path, include_labels= None, split=None, split_file=None,
                 ...
                 transform_dict_core=None, transform_dict_artifact=None, transform_global_core=None, transform_global_artifact=None):
        """
        ...
        transform_dict_core, transform_dict_artifact, transform_global_core, transform_global_artifact)
