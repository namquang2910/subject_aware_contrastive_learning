...
BASE_OUTPUT = "./save"
DATASET_DIC = {'WESADDataset':'/home/s223149341/SSL-invariance-Subject_Project_model/data/WESAD/wesad_10_05_minmax',
               'SWELLDataset':'/home/s223149341/SSL-invariance-Subject_Project_model/data/SWELL/SWELL_1280_320_minmax',
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default=None , choices=["WESADDataset", "SWELLDataset", "PsychioNet"], help="Pretrain dataset")
